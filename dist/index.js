(() => {
  ...
  __commonjs = {
    ...
    17(exports, module) {
      ...
      "use strict";
      var Vnode = __require(20 /* ../render/vnode */);
    ...
    16(exports, module) {
      ...
      "use strict";
      var Vnode = __require(20 /* ../render/vnode */);
      var hyperscriptVnode = __require(17 /* ./hyperscriptVnode */);
    ...
    3(exports, module) {
      ...
      "use strict";
      var hyperscript = __require(16 /* ./render/hyperscript */);
      hyperscript.trust = __require(19 /* ./render/trust */);
      hyperscript.fragment = __require(15 /* ./render/fragment */);
      module.exports = hyperscript;
    },
    ...
    11(exports, module) {
      ...
      "use strict";
      var PromisePolyfill = __require(10 /* ./polyfill */);
    ...
    14(exports, module) {
      ...
      "use strict";
      module.exports = __require(18 /* ./render/render */)(window);
    },
    ...
    5(exports, module) {
      ...
      "use strict";
      var render = __require(14 /* ./render */);
      module.exports = __require(1 /* ./api/mount-redraw */)(render, requestAnimationFrame, console);
    },
    ...
    7(exports, module) {
      ...
      "use strict";
      var buildQueryString = __require(12 /* ../querystring/build */);
      var assign = __require(6 /* ./assign */);
    ...
    22(exports, module) {
      ...
      "use strict";
      var buildPathname = __require(7 /* ../pathname/build */);
      module.exports = function($window, Promise2, oncompletion) {
        ...
        return {
          ...
          jsonp: makeRequest(function(url, args, resolve, reject) {
            var callbackName = args.callbackName || "_mithril_" + Math.round(Math.random() * 1e+16) + "_" + callbackCount++;
    ...
    21(exports, module) {
      ...
      "use strict";
      var PromisePolyfill = __require(11 /* ./promise/promise */);
      var mountRedraw = __require(5 /* ./mount-redraw */);
      module.exports = __require(22 /* ./request/request */)(window, PromisePolyfill, mountRedraw.redraw);
    },
    ...
    9(exports, module) {
      ...
      "use strict";
      var parseQueryString = __require(13 /* ../querystring/parse */);
    ...
    8(exports, module) {
      ...
      "use strict";
      var parsePathname = __require(9 /* ./parse */);
    ...
    2(exports, module) {
      ...
      "use strict";
      var Vnode = __require(20 /* ../render/vnode */);
      var m = __require(16 /* ../render/hyperscript */);
      var Promise2 = __require(11 /* ../promise/promise */);
      var buildPathname = __require(7 /* ../pathname/build */);
      var parsePathname = __require(9 /* ../pathname/parse */);
      var compileTemplate = __require(8 /* ../pathname/compileTemplate */);
      var assign = __require(6 /* ../pathname/assign */);
      var sentinel = {};
      module.exports = function($window, mountRedraw) {
        ...
        route.Link = {
          view: function(vnode) {
            ...
            var child = m(vnode.attrs.selector || "a", attrs2, vnode.children);
    ...
    23(exports, module) {
      ...
      "use strict";
      var mountRedraw = __require(5 /* ./mount-redraw */);
      module.exports = __require(2 /* ./api/router */)(window, mountRedraw);
    },

    4(exports, module) {
      // node_modules/mithril/index.js
      "use strict";
      var hyperscript = __require(3 /* ./hyperscript */);
      var request = __require(21 /* ./request */);
      var mountRedraw = __require(5 /* ./mount-redraw */);
      var m = function m2() {
      ...
      m.route = __require(23 /* ./route */);
      m.render = __require(14 /* ./render */);
      m.redraw = mountRedraw.redraw;
      m.request = request.request;
      m.jsonp = request.jsonp;
      m.parseQueryString = __require(13 /* ./querystring/parse */);
      m.buildQueryString = __require(12 /* ./querystring/build */);
      m.parsePathname = __require(9 /* ./pathname/parse */);
      m.buildPathname = __require(7 /* ./pathname/build */);
      m.vnode = __require(20 /* ./render/vnode */);
      m.PromisePolyfill = __require(10 /* ./promise/polyfill */);
      module.exports = m;
    },

    0() {
      // js/index.js
      const mithril = __import(4 /* mithril */);
      var Home, delay_fadeout, todo;
      delay_fadeout = function(response) {
      ...
      todo = {
        newTodoName: "",
        setNewTodoName: function(value) {
          return todo.newTodoName = value;
        },
        post_new_todo: function(e) {
          e.preventDefault();
          return mithril.default.request({
            method: "post",
            url: "/todo",
            body: {
              name: todo.newTodoName
            }
          }).then(delay_fadeout);
        },
        data: [],
      ...
      Home = {
        view: function() {
          todo.get_all();
          return mithril.default(".container", [mithril.default(".card", [mithril.default(".card-header", [mithril.default("a", {
            href: "https://blog.logrocket.com/create-an-async-crud-web-service-in-rust-with-warp/"
          }, "warp-postgres-example")]), mithril.default(".card-body", [mithril.default(".row", [mithril.default(".col", [mithril.default("form.form-inline", [mithril.default(".form-group", [mithril.default("label.mr-2", "New Todo "), mithril.default("input.form-control[type=text]", {
            oninput: function(e) {
              return todo.setNewTodoName(e.target.value);
            },
            value: todo.newTodoName
          })]), mithril.default("button.btn.btn-light", {
            type: "submit",
            onclick: todo.post_new_todo
          }, "Submit")])]), mithril.default(".col", [mithril.default("label.btn.btn-light", {
            onclick: todo.get_all
          }, "Reload")])]), mithril.default("table.table.table-condensed", [mithril.default("thead", [mithril.default("tr", ["id", "name", "checked"].map(function(h) {
            return mithril.default("th", h);
          }))]), mithril.default("tbody", todo.data.map(function(item) {
            return mithril.default("tr", [mithril.default("td", [item.id, mithril.default("span.badge.badge-warning.ml-2", {
              onclick: function() {
                return todo.delete(item.id);
              }
            }, "Delete")]), mithril.default("td", item.name), mithril.default("td", [mithril.default("span.badge", {
              class: item.checked ? "badge-secondary" : "badge-primary",
              onclick: function() {
                return todo.toggle_checked(item);
              }
            }, item.checked ? "done" : "Do")])]);
          }))]), todo.response ? mithril.default("label.form-control", JSON.stringify(todo.response)) : void 0])])]);
        }
      };
      mithril.default.mount(document.getElementById("contents"), Home);
    }
  };
  return __require(0);
})();
